...
class TriageService {
  RiskTier classify(List<String> symptoms, int durationDays, {List<String> customSymptoms = const [], double? temperature, String? tempUnit, List<String> comorbidities = const []}) {
    if (symptoms.isEmpty && customSymptoms.isEmpty && temperature == null) return RiskTier.green;

    int severityScore = 0;
    
    // Add severity for custom symptoms
    severityScore += customSymptoms.length;
